...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_survey', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored_surveys', to=orm['auth.User'])),
        ))
        ...
        # Adding model 'CheckboxQuestion'
        db.create_table('main_checkboxquestion', (
        ...
        db.send_create_signal('main', ['CheckboxQuestion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CheckboxQuestion'
        db.delete_table('main_checkboxquestion')
