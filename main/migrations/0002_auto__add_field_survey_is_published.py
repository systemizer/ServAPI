...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Survey.is_published'
        db.add_column('main_survey', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Survey.is_published'
        db.delete_column('main_survey', 'is_published')
